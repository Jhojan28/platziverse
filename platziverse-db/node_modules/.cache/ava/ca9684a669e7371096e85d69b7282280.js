...
var _bluebird = require('../../../Library/Caches/typescript/2.6/node_modules/@types/bluebird');
...
test.beforeEach(async () => {
    ...
    AgentStub.create.withArgs(newAgent).returns(_bluebird.Promise.resolve({
        toJSON() {
            return newAgent;
        }
    }));
    ...
    AgentStub.findOne.withArgs(uuidArgs).returns(_bluebird.Promise.resolve(agentFixtures.byUuid(uuid)));

    //model update
    AgentStub.update = sandbox.stub();
    AgentStub.update.withArgs(single, uuidArgs).returns(_bluebird.Promise.resolve(single));
    ...
    AgentStub.findAll.withArgs().returns(_bluebird.Promise.resolve(agentFixtures.all));
    AgentStub.findAll.withArgs(connectedArgs).returns(_bluebird.Promise.resolve(agentFixtures.connected));
    AgentStub.findAll.withArgs(usernameArgs).returns(_bluebird.Promise.resolve(agentFixtures.platzi));
...
test.serial('Setup', t => {
    ...
    t.true(_rec3._expr(_rec3._capt(_rec3._capt(_rec3._capt(AgentStub, 'arguments/0/callee/object/object').hasMany, 'arguments/0/callee/object').calledWith(_rec3._capt(MetricStub, 'arguments/0/arguments/0')), 'arguments/0'), {
        content: 't.true(AgentStub.hasMany.calledWith(MetricStub), \'Argument should be MetricStub\')',
        filepath: 'tests/agent-tests.js',
        line: 96,
        ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"true","range":[2,6]},"computed":false,"range":[0,6]},"arguments":[{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"MemberExpression","object":{"type":"Identifier","name":"AgentStub","range":[7,16]},"property":{"type":"Identifier","name":"hasMany","range":[17,24]},"computed":false,"range":[7,24]},"property":{"type":"Identifier","name":"calledWith","range":[25,35]},"computed":false,"range":[7,35]},"arguments":[{"type":"Identifier","name":"MetricStub","range":[36,46]}],"range":[7,47]},{"type":"StringLiteral","value":"Argument should be MetricStub","range":[49,80]}],"range":[0,81]}',
        tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"true"},"value":"true","range":[2,6]},{"type":{"label":"("},"range":[6,7]},{"type":{"label":"name"},"value":"AgentStub","range":[7,16]},{"type":{"label":"."},"range":[16,17]},{"type":{"label":"name"},"value":"hasMany","range":[17,24]},{"type":{"label":"."},"range":[24,25]},{"type":{"label":"name"},"value":"calledWith","range":[25,35]},{"type":{"label":"("},"range":[35,36]},{"type":{"label":"name"},"value":"MetricStub","range":[36,46]},{"type":{"label":")"},"range":[46,47]},{"type":{"label":","},"range":[47,48]},{"type":{"label":"string"},"value":"Argument should be MetricStub","range":[49,80]},{"type":{"label":")"},"range":[80,81]}]',
        visitorKeys: _powerAssertVisitorKeys
    }), 'Argument should be MetricStub');
    ...
    t.true(_rec5._expr(_rec5._capt(_rec5._capt(_rec5._capt(MetricStub, 'arguments/0/callee/object/object').belongsTo, 'arguments/0/callee/object').calledWith(_rec5._capt(AgentStub, 'arguments/0/arguments/0')), 'arguments/0'), {
        content: 't.true(MetricStub.belongsTo.calledWith(AgentStub), \'Argument should be AgentStub\')',
        filepath: 'tests/agent-tests.js',
        line: 98,
        ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"true","range":[2,6]},"computed":false,"range":[0,6]},"arguments":[{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"MemberExpression","object":{"type":"Identifier","name":"MetricStub","range":[7,17]},"property":{"type":"Identifier","name":"belongsTo","range":[18,27]},"computed":false,"range":[7,27]},"property":{"type":"Identifier","name":"calledWith","range":[28,38]},"computed":false,"range":[7,38]},"arguments":[{"type":"Identifier","name":"AgentStub","range":[39,48]}],"range":[7,49]},{"type":"StringLiteral","value":"Argument should be AgentStub","range":[51,81]}],"range":[0,82]}',
        tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"true"},"value":"true","range":[2,6]},{"type":{"label":"("},"range":[6,7]},{"type":{"label":"name"},"value":"MetricStub","range":[7,17]},{"type":{"label":"."},"range":[17,18]},{"type":{"label":"name"},"value":"belongsTo","range":[18,27]},{"type":{"label":"."},"range":[27,28]},{"type":{"label":"name"},"value":"calledWith","range":[28,38]},{"type":{"label":"("},"range":[38,39]},{"type":{"label":"name"},"value":"AgentStub","range":[39,48]},{"type":{"label":")"},"range":[48,49]},{"type":{"label":","},"range":[49,50]},{"type":{"label":"string"},"value":"Argument should be AgentStub","range":[51,81]},{"type":{"label":")"},"range":[81,82]}]',
        visitorKeys: _powerAssertVisitorKeys
    }), 'Argument should be AgentStub');
});
...
test.serial('Agent#createOrUpdate - exists', async t => {
    ...
    t.true(_rec11._expr(_rec11._capt(_rec11._capt(_rec11._capt(AgentStub, 'arguments/0/callee/object/object').findOne, 'arguments/0/callee/object').calledWith(_rec11._capt(uuidArgs, 'arguments/0/arguments/0')), 'arguments/0'), {
        content: 't.true(AgentStub.findOne.calledWith(uuidArgs), \'FindOne should be called width uuidArgs\')',
        filepath: 'tests/agent-tests.js',
        line: 115,
        async: true,
        ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"true","range":[2,6]},"computed":false,"range":[0,6]},"arguments":[{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"MemberExpression","object":{"type":"Identifier","name":"AgentStub","range":[7,16]},"property":{"type":"Identifier","name":"findOne","range":[17,24]},"computed":false,"range":[7,24]},"property":{"type":"Identifier","name":"calledWith","range":[25,35]},"computed":false,"range":[7,35]},"arguments":[{"type":"Identifier","name":"uuidArgs","range":[36,44]}],"range":[7,45]},{"type":"StringLiteral","value":"FindOne should be called width uuidArgs","range":[47,88]}],"range":[0,89]}',
        ...
        visitorKeys: _powerAssertVisitorKeys
    }), 'FindOne should be called width uuidArgs');
    t.true(_rec12._expr(_rec12._capt(_rec12._capt(_rec12._capt(AgentStub, 'arguments/0/object/object').update, 'arguments/0/object').called, 'arguments/0'), {
        content: 't.true(AgentStub.update.called, "Update should be called on model")',
        filepath: 'tests/agent-tests.js',
        line: 116,
        async: true,
        ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"true","range":[2,6]},"computed":false,"range":[0,6]},"arguments":[{"type":"MemberExpression","object":{"type":"MemberExpression","object":{"type":"Identifier","name":"AgentStub","range":[7,16]},"property":{"type":"Identifier","name":"update","range":[17,23]},"computed":false,"range":[7,23]},"property":{"type":"Identifier","name":"called","range":[24,30]},"computed":false,"range":[7,30]},{"type":"StringLiteral","value":"Update should be called on model","range":[32,66]}],"range":[0,67]}',
        tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"true"},"value":"true","range":[2,6]},{"type":{"label":"("},"range":[6,7]},{"type":{"label":"name"},"value":"AgentStub","range":[7,16]},{"type":{"label":"."},"range":[16,17]},{"type":{"label":"name"},"value":"update","range":[17,23]},{"type":{"label":"."},"range":[23,24]},{"type":{"label":"name"},"value":"called","range":[24,30]},{"type":{"label":","},"range":[30,31]},{"type":{"label":"string"},"value":"Update should be called on model","range":[32,66]},{"type":{"label":")"},"range":[66,67]}]',
        visitorKeys: _powerAssertVisitorKeys
    }), "Update should be called on model");
    ...
    t.true(_rec14._expr(_rec14._capt(_rec14._capt(_rec14._capt(AgentStub, 'arguments/0/callee/object/object').update, 'arguments/0/callee/object').calledWith(_rec14._capt(single, 'arguments/0/arguments/0')), 'arguments/0'), {
        content: 't.true(AgentStub.update.calledWith(single), "Update should be called width single args")',
        filepath: 'tests/agent-tests.js',
        line: 118,
        async: true,
        ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"true","range":[2,6]},"computed":false,"range":[0,6]},"arguments":[{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"MemberExpression","object":{"type":"Identifier","name":"AgentStub","range":[7,16]},"property":{"type":"Identifier","name":"update","range":[17,23]},"computed":false,"range":[7,23]},"property":{"type":"Identifier","name":"calledWith","range":[24,34]},"computed":false,"range":[7,34]},"arguments":[{"type":"Identifier","name":"single","range":[35,41]}],"range":[7,42]},{"type":"StringLiteral","value":"Update should be called width single args","range":[44,87]}],"range":[0,88]}',
        tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"true"},"value":"true","range":[2,6]},{"type":{"label":"("},"range":[6,7]},{"type":{"label":"name"},"value":"AgentStub","range":[7,16]},{"type":{"label":"."},"range":[16,17]},{"type":{"label":"name"},"value":"update","range":[17,23]},{"type":{"label":"."},"range":[23,24]},{"type":{"label":"name"},"value":"calledWith","range":[24,34]},{"type":{"label":"("},"range":[34,35]},{"type":{"label":"name"},"value":"single","range":[35,41]},{"type":{"label":")"},"range":[41,42]},{"type":{"label":","},"range":[42,43]},{"type":{"label":"string"},"value":"Update should be called width single args","range":[44,87]},{"type":{"label":")"},"range":[87,88]}]',
        visitorKeys: _powerAssertVisitorKeys
    }), "Update should be called width single args");
...
test.serial('Agent#findAll', async t => {
    ...
    t.true(_rec17._expr(_rec17._capt(_rec17._capt(_rec17._capt(AgentStub, 'arguments/0/callee/object/object').findOne, 'arguments/0/callee/object').calledWith(), 'arguments/0'), {
        content: 't.true(AgentStub.findOne.calledWith(), "FindAll should be called without args")',
        filepath: 'tests/agent-tests.js',
        line: 127,
        async: true,
        ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"true","range":[2,6]},"computed":false,"range":[0,6]},"arguments":[{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"MemberExpression","object":{"type":"Identifier","name":"AgentStub","range":[7,16]},"property":{"type":"Identifier","name":"findOne","range":[17,24]},"computed":false,"range":[7,24]},"property":{"type":"Identifier","name":"calledWith","range":[25,35]},"computed":false,"range":[7,35]},"arguments":[],"range":[7,37]},{"type":"StringLiteral","value":"FindAll should be called without args","range":[39,78]}],"range":[0,79]}',
        tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"true"},"value":"true","range":[2,6]},{"type":{"label":"("},"range":[6,7]},{"type":{"label":"name"},"value":"AgentStub","range":[7,16]},{"type":{"label":"."},"range":[16,17]},{"type":{"label":"name"},"value":"findOne","range":[17,24]},{"type":{"label":"."},"range":[24,25]},{"type":{"label":"name"},"value":"calledWith","range":[25,35]},{"type":{"label":"("},"range":[35,36]},{"type":{"label":")"},"range":[36,37]},{"type":{"label":","},"range":[37,38]},{"type":{"label":"string"},"value":"FindAll should be called without args","range":[39,78]},{"type":{"label":")"},"range":[78,79]}]',
        visitorKeys: _powerAssertVisitorKeys
...
test.serial('Agent#findByUsername', async t => {
    ...
    t.true(_rec20._expr(_rec20._capt(_rec20._capt(_rec20._capt(AgentStub, 'arguments/0/callee/object/object').findOne, 'arguments/0/callee/object').calledWith(_rec20._capt(username, 'arguments/0/arguments/0')), 'arguments/0'), {
        content: 't.true(AgentStub.findOne.calledWith(username), "FindAll should be called with usernameArgs")',
        filepath: 'tests/agent-tests.js',
        line: 138,
        async: true,
        ...
        tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"true"},"value":"true","range":[2,6]},{"type":{"label":"("},"range":[6,7]},{"type":{"label":"name"},"value":"AgentStub","range":[7,16]},{"type":{"label":"."},"range":[16,17]},{"type":{"label":"name"},"value":"findOne","range":[17,24]},{"type":{"label":"."},"range":[24,25]},{"type":{"label":"name"},"value":"calledWith","range":[25,35]},{"type":{"label":"("},"range":[35,36]},{"type":{"label":"name"},"value":"username","range":[36,44]},{"type":{"label":")"},"range":[44,45]},{"type":{"label":","},"range":[45,46]},{"type":{"label":"string"},"value":"FindAll should be called with usernameArgs","range":[47,91]},{"type":{"label":")"},"range":[91,92]}]',
        visitorKeys: _powerAssertVisitorKeys
...
test.serial('Agent#findConnected', async t => {
    ...
    t.true(_rec23._expr(_rec23._capt(_rec23._capt(_rec23._capt(AgentStub, 'arguments/0/callee/object/object').findOne, 'arguments/0/callee/object').calledWith(_rec23._capt(connectedArgs, 'arguments/0/arguments/0')), 'arguments/0'), {
        content: 't.true(AgentStub.findOne.calledWith(connectedArgs), "FindAll should be called with connectedArgs")',
        filepath: 'tests/agent-tests.js',
        line: 149,
        async: true,
        ...
        tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"true"},"value":"true","range":[2,6]},{"type":{"label":"("},"range":[6,7]},{"type":{"label":"name"},"value":"AgentStub","range":[7,16]},{"type":{"label":"."},"range":[16,17]},{"type":{"label":"name"},"value":"findOne","range":[17,24]},{"type":{"label":"."},"range":[24,25]},{"type":{"label":"name"},"value":"calledWith","range":[25,35]},{"type":{"label":"("},"range":[35,36]},{"type":{"label":"name"},"value":"connectedArgs","range":[36,49]},{"type":{"label":")"},"range":[49,50]},{"type":{"label":","},"range":[50,51]},{"type":{"label":"string"},"value":"FindAll should be called with connectedArgs","range":[52,97]},{"type":{"label":")"},"range":[97,98]}]',
        visitorKeys: _powerAssertVisitorKeys
    ...
    t.deepEqual(agent, agentFixtures.conntected, 'Agent should be the same');
});
...
test.serial('Agent#createOrUpdate - new', async t => {
    ...
    t.true(_rec25._expr(_rec25._capt(_rec25._capt(_rec25._capt(AgentStub, 'arguments/0/object/object').findOne, 'arguments/0/object').calledOnce, 'arguments/0'), {
        content: 't.true(AgentStub.findOne.calledOnce, \'FindOne should be called twice\')',
        filepath: 'tests/agent-tests.js',
        line: 159,
        async: true,
    ...
    t.true(_rec29._expr(_rec29._capt(_rec29._capt(_rec29._capt(AgentStub, 'arguments/0/callee/object/object').create, 'arguments/0/callee/object').calledWith(_rec29._capt(newAgent, 'arguments/0/arguments/0')), 'arguments/0'), {
        content: 't.true(AgentStub.create.calledWith(newAgent), \'create should be called with newAgent args\')',
        filepath: 'tests/agent-tests.js',
        line: 165,
        async: true,
        ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"true","range":[2,6]},"computed":false,"range":[0,6]},"arguments":[{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"MemberExpression","object":{"type":"Identifier","name":"AgentStub","range":[7,16]},"property":{"type":"Identifier","name":"create","range":[17,23]},"computed":false,"range":[7,23]},"property":{"type":"Identifier","name":"calledWith","range":[24,34]},"computed":false,"range":[7,34]},"arguments":[{"type":"Identifier","name":"newAgent","range":[35,43]}],"range":[7,44]},{"type":"StringLiteral","value":"create should be called with newAgent args","range":[46,90]}],"range":[0,91]}',
        tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"true"},"value":"true","range":[2,6]},{"type":{"label":"("},"range":[6,7]},{"type":{"label":"name"},"value":"AgentStub","range":[7,16]},{"type":{"label":"."},"range":[16,17]},{"type":{"label":"name"},"value":"create","range":[17,23]},{"type":{"label":"."},"range":[23,24]},{"type":{"label":"name"},"value":"calledWith","range":[24,34]},{"type":{"label":"("},"range":[34,35]},{"type":{"label":"name"},"value":"newAgent","range":[35,43]},{"type":{"label":")"},"range":[43,44]},{"type":{"label":","},"range":[44,45]},{"type":{"label":"string"},"value":"create should be called with newAgent args","range":[46,90]},{"type":{"label":")"},"range":[90,91]}]',
        visitorKeys: _powerAssertVisitorKeys
    }), 'create should be called with newAgent args');
    t.deepEqual(agent, single, 'Agent should be the same');
});
//# sourceMappingURL=../node_modules/.cache/ava/ca9684a669e7371096e85d69b7282280.js.map