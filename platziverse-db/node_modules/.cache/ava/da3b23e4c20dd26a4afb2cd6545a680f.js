...
test.beforeEach(async () => {
  ...
  MetricStub.create.withArgs(newMetric).returns(Promise.resolve({
    toJSON() {
      return Object.assign(newMetric, { agentId: agentId });
    }
  }));
...
test.serial('Metric#findByUuid', async t => {
  ...
  t.true(_rec2._expr(_rec2._capt(_rec2._capt(_rec2._capt(MetricStub, 'arguments/0/object/object').findAll, 'arguments/0/object').called, 'arguments/0'), {
  ...
  t.true(_rec3._expr(_rec3._capt(_rec3._capt(_rec3._capt(MetricStub, 'arguments/0/object/object').findAll, 'arguments/0/object').calledOnce, 'arguments/0'), {
  ...
  t.true(_rec4._expr(_rec4._capt(_rec4._capt(_rec4._capt(MetricStub, 'arguments/0/callee/object/object').findAll, 'arguments/0/callee/object').calledWith(_rec4._capt(uuidArgs, 'arguments/0/arguments/0')), 'arguments/0'), {
    content: 't.true(MetricStub.findAll.calledWith(uuidArgs), \'findAll should be called with specified args\')',
    filepath: 'tests/metric-test.js',
    line: 135,
    async: true,
    ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"true","range":[2,6]},"computed":false,"range":[0,6]},"arguments":[{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"MemberExpression","object":{"type":"Identifier","name":"MetricStub","range":[7,17]},"property":{"type":"Identifier","name":"findAll","range":[18,25]},"computed":false,"range":[7,25]},"property":{"type":"Identifier","name":"calledWith","range":[26,36]},"computed":false,"range":[7,36]},"arguments":[{"type":"Identifier","name":"uuidArgs","range":[37,45]}],"range":[7,46]},{"type":"StringLiteral","value":"findAll should be called with specified args","range":[48,94]}],"range":[0,95]}',
    tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"true"},"value":"true","range":[2,6]},{"type":{"label":"("},"range":[6,7]},{"type":{"label":"name"},"value":"MetricStub","range":[7,17]},{"type":{"label":"."},"range":[17,18]},{"type":{"label":"name"},"value":"findAll","range":[18,25]},{"type":{"label":"."},"range":[25,26]},{"type":{"label":"name"},"value":"calledWith","range":[26,36]},{"type":{"label":"("},"range":[36,37]},{"type":{"label":"name"},"value":"uuidArgs","range":[37,45]},{"type":{"label":")"},"range":[45,46]},{"type":{"label":","},"range":[46,47]},{"type":{"label":"string"},"value":"findAll should be called with specified args","range":[48,94]},{"type":{"label":")"},"range":[94,95]}]',
    visitorKeys: _powerAssertVisitorKeys
  }), 'findAll should be called with specified args');
...
test.serial('Metric#findByTypeAgentUuid', async t => {
  ...
  t.true(_rec5._expr(_rec5._capt(_rec5._capt(_rec5._capt(MetricStub, 'arguments/0/object/object').findAll, 'arguments/0/object').called, 'arguments/0'), {
    content: 't.true(MetricStub.findAll.called, \'findAll should be called on Model\')',
    filepath: 'tests/metric-test.js',
    line: 142,
    async: true,
  ...
  t.true(_rec6._expr(_rec6._capt(_rec6._capt(_rec6._capt(MetricStub, 'arguments/0/object/object').findAll, 'arguments/0/object').calledOnce, 'arguments/0'), {
    content: 't.true(MetricStub.findAll.calledOnce, \'findAll should be called once\')',
    filepath: 'tests/metric-test.js',
    line: 143,
    async: true,
  ...
  t.true(_rec7._expr(_rec7._capt(_rec7._capt(_rec7._capt(MetricStub, 'arguments/0/callee/object/object').findAll, 'arguments/0/callee/object').calledWith(_rec7._capt(typeUuidArgs, 'arguments/0/arguments/0')), 'arguments/0'), {
    content: 't.true(MetricStub.findAll.calledWith(typeUuidArgs), \'findAll should be called with specified args\')',
    filepath: 'tests/metric-test.js',
    line: 144,
    async: true,
    ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"true","range":[2,6]},"computed":false,"range":[0,6]},"arguments":[{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"MemberExpression","object":{"type":"Identifier","name":"MetricStub","range":[7,17]},"property":{"type":"Identifier","name":"findAll","range":[18,25]},"computed":false,"range":[7,25]},"property":{"type":"Identifier","name":"calledWith","range":[26,36]},"computed":false,"range":[7,36]},"arguments":[{"type":"Identifier","name":"typeUuidArgs","range":[37,49]}],"range":[7,50]},{"type":"StringLiteral","value":"findAll should be called with specified args","range":[52,98]}],"range":[0,99]}',
    tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"true"},"value":"true","range":[2,6]},{"type":{"label":"("},"range":[6,7]},{"type":{"label":"name"},"value":"MetricStub","range":[7,17]},{"type":{"label":"."},"range":[17,18]},{"type":{"label":"name"},"value":"findAll","range":[18,25]},{"type":{"label":"."},"range":[25,26]},{"type":{"label":"name"},"value":"calledWith","range":[26,36]},{"type":{"label":"("},"range":[36,37]},{"type":{"label":"name"},"value":"typeUuidArgs","range":[37,49]},{"type":{"label":")"},"range":[49,50]},{"type":{"label":","},"range":[50,51]},{"type":{"label":"string"},"value":"findAll should be called with specified args","range":[52,98]},{"type":{"label":")"},"range":[98,99]}]',
    visitorKeys: _powerAssertVisitorKeys
  }), 'findAll should be called with specified args');
...
test.serial('Metric#create', async t => {
  ...
  t.true(_rec8._expr(_rec8._capt(_rec8._capt(_rec8._capt(AgentStub, 'arguments/0/object/object').findOne, 'arguments/0/object').called, 'arguments/0'), {
  ...
  t.true(_rec9._expr(_rec9._capt(_rec9._capt(_rec9._capt(AgentStub, 'arguments/0/object/object').findOne, 'arguments/0/object').calledOnce, 'arguments/0'), {
  ...
  t.true(_rec10._expr(_rec10._capt(_rec10._capt(_rec10._capt(AgentStub, 'arguments/0/callee/object/object').findOne, 'arguments/0/callee/object').calledWith(_rec10._capt(oneAgentArgs, 'arguments/0/arguments/0')), 'arguments/0'), {
    content: 't.true(AgentStub.findOne.calledWith(oneAgentArgs), \'findOne should be called with specified agentId\')',
    filepath: 'tests/metric-test.js',
    line: 154,
    async: true,
    ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"true","range":[2,6]},"computed":false,"range":[0,6]},"arguments":[{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"MemberExpression","object":{"type":"Identifier","name":"AgentStub","range":[7,16]},"property":{"type":"Identifier","name":"findOne","range":[17,24]},"computed":false,"range":[7,24]},"property":{"type":"Identifier","name":"calledWith","range":[25,35]},"computed":false,"range":[7,35]},"arguments":[{"type":"Identifier","name":"oneAgentArgs","range":[36,48]}],"range":[7,49]},{"type":"StringLiteral","value":"findOne should be called with specified agentId","range":[51,100]}],"range":[0,101]}',
    ...
    visitorKeys: _powerAssertVisitorKeys
  }), 'findOne should be called with specified agentId');

  t.true(_rec11._expr(_rec11._capt(_rec11._capt(_rec11._capt(MetricStub, 'arguments/0/object/object').create, 'arguments/0/object').called, 'arguments/0'), {
  ...
  t.true(_rec12._expr(_rec12._capt(_rec12._capt(_rec12._capt(MetricStub, 'arguments/0/object/object').create, 'arguments/0/object').calledOnce, 'arguments/0'), {
  ...
  t.true(_rec13._expr(_rec13._capt(_rec13._capt(_rec13._capt(MetricStub, 'arguments/0/callee/object/object').create, 'arguments/0/callee/object').calledWith(_rec13._capt(newMetric, 'arguments/0/arguments/0')), 'arguments/0'), {
...
//# sourceMappingURL=../node_modules/.cache/ava/da3b23e4c20dd26a4afb2cd6545a680f.js.map