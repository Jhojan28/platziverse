...
test.serial('Agent#findByUsername', async t => {
  ...
  t.true(_rec20._expr(_rec20._capt(_rec20._capt(_rec20._capt(AgentStub, 'arguments/0/callee/object/object').findOne, 'arguments/0/callee/object').calledWith(_rec20._capt(usernameArgs, 'arguments/0/arguments/0')), 'arguments/0'), {
    content: 't.true(AgentStub.findOne.calledWith(usernameArgs), \'FindAll should be called with usernameArgs\')',
    filepath: 'tests/agent-tests.js',
    line: 135,
    async: true,
    ...
    tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"true"},"value":"true","range":[2,6]},{"type":{"label":"("},"range":[6,7]},{"type":{"label":"name"},"value":"AgentStub","range":[7,16]},{"type":{"label":"."},"range":[16,17]},{"type":{"label":"name"},"value":"findOne","range":[17,24]},{"type":{"label":"."},"range":[24,25]},{"type":{"label":"name"},"value":"calledWith","range":[25,35]},{"type":{"label":"("},"range":[35,36]},{"type":{"label":"name"},"value":"usernameArgs","range":[36,48]},{"type":{"label":")"},"range":[48,49]},{"type":{"label":","},"range":[49,50]},{"type":{"label":"string"},"value":"FindAll should be called with usernameArgs","range":[51,95]},{"type":{"label":")"},"range":[95,96]}]',
    visitorKeys: _powerAssertVisitorKeys
...
//# sourceMappingURL=../node_modules/.cache/ava/19986f2dbed83d09f91126681418c211.js.map