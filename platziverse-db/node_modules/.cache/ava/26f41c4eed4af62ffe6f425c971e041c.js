...
test.serial('Setup', t => {
    ...
    t.true(_rec3._expr(_rec3._capt(_rec3._capt(_rec3._capt(MetricStub, 'arguments/0/object/object').belogsTo, 'arguments/0/object').called, 'arguments/0'), {
        content: 't.true(MetricStub.belogsTo.called, \'MetricModel.belogsTo was executed\')',
        filepath: 'tests/agent-tests.js',
        line: 38,
        ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"true","range":[2,6]},"computed":false,"range":[0,6]},"arguments":[{"type":"MemberExpression","object":{"type":"MemberExpression","object":{"type":"Identifier","name":"MetricStub","range":[7,17]},"property":{"type":"Identifier","name":"belogsTo","range":[18,26]},"computed":false,"range":[7,26]},"property":{"type":"Identifier","name":"called","range":[27,33]},"computed":false,"range":[7,33]},{"type":"StringLiteral","value":"MetricModel.belogsTo was executed","range":[35,70]}],"range":[0,71]}',
        tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"true"},"value":"true","range":[2,6]},{"type":{"label":"("},"range":[6,7]},{"type":{"label":"name"},"value":"MetricStub","range":[7,17]},{"type":{"label":"."},"range":[17,18]},{"type":{"label":"name"},"value":"belogsTo","range":[18,26]},{"type":{"label":"."},"range":[26,27]},{"type":{"label":"name"},"value":"called","range":[27,33]},{"type":{"label":","},"range":[33,34]},{"type":{"label":"string"},"value":"MetricModel.belogsTo was executed","range":[35,70]},{"type":{"label":")"},"range":[70,71]}]',
        visitorKeys: _powerAssertVisitorKeys
    }), 'MetricModel.belogsTo was executed');
});
//# sourceMappingURL=../node_modules/.cache/ava/26f41c4eed4af62ffe6f425c971e041c.js.map